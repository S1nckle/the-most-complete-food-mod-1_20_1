...
import net.shawdy.themostcompletefoodmod.network.C2SRequestDietContainerDataPacket;
...
public class DietContainerScreen extends Screen {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(TheMostCompleteFoodMod.MOD_ID, "textures/gui/player_diet_container_gui.png");
